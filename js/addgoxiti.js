/*
	...
	2013-7-14
*/
function addgoxiti(cmd,title,l_submit,l_close,l_tips,l_help) {

	checkFocus();
	show_goxiti_Editor(cmd,title,l_submit,l_close,l_tips,l_help);
	return;
}
function show_goxiti_Editor(tag,title,l_submit,l_close,l_tips,l_help,params) {
	...
	s='<table width="100%" cellpadding="0" cellspacing="0" class="fwin"><tr><td class="t_l"></td><td class="t_c"></td><td class="t_r"></td></tr><tr><td class="m_l">&nbsp;&nbsp;</td><td class="m_c"><div class="mtm">'
		+ '<ul class="tb tb_s cl" style="margin-top:0;margin-bottom:0;">'
			+'<li class="y"><span class="flbc" onclick="hideMenu(\'\', \'goxitiexit\');return false;">'+l_close+'</span></li>'
	...
	if($(ctrlid + '_submit')) $(ctrlid + '_submit').onclick = function() {
		...
		}else {sgfcode="(;C[SGF´íÎó])";}
		
		var strimg3 = '[goxiti]' + sgfcode + '[/goxiti]';
			if(wysiwyg) {		
